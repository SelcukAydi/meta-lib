...
TEST(ConversionVector, 0)
{
    ...
    using Result = sia::meta::Exec<sia::meta::detail::ConversionVectorFindPair(int, M1)>::type;
    static_assert(std::is_same_v<sia::meta::detail::Pair<int, float>, Result>);

    using Result1 = sia::meta::Exec<sia::meta::detail::ConversionVectorFindPair(float, M1)>::type;
    static_assert(std::is_same_v<Result1, sia::meta::None>);
}

TEST(ConversionVector, 1)
{
    using M1 =
        sia::meta::detail::ConversionVector<sia::meta::detail::Pair<int, float>, sia::meta::detail::Pair<char, bool>>;
    using Result =
        sia::meta::Exec<sia::meta::detail::ConversionVectorRemovePair(sia::meta::detail::Pair<char, bool>, M1)>::type;
