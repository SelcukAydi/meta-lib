...
TC_BEGIN(ConversionVector, 3)
{
    using M1 = sia::meta::detail::ConversionVector<sia::meta::detail::Pair<int, float>>;
    using Result = sia::meta::Exec<sia::meta::detail::ConversionVectorAddPair(sia::meta::detail::Pair<char, bool>, M1)>::type;
    static_assert(std::is_same_v<Result, sia::meta::detail::ConversionVector<sia::meta::detail::Pair<int, float>, sia::meta::detail::Pair<char, bool>>>);
}
